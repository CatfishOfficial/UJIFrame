...
const CommandDef COMMANDS[] = {
  ...
  { "calc",      "Tools",  "Calculator (+ solve, 2nd keypad)",EXT_NUMERIC,    nullptr,         0,                    calcRun },
  { "weather",   "Tools",  "Current weather (needs WiFi)",    EXT_NONE,       nullptr,         0,                    weatherRun },
  { "alarm",     "Tools",  "Alarms: set, list, delete",       EXT_TIME_ENTRY, nullptr,         0,                    alarmRun },
  { "timer",     "Tools",  "Countdown timer",                 EXT_TIME_ENTRY, nullptr,         0,                    timerRun },
  { "stopwatch", "Tools",  "Stopwatch (tap to start/stop)",   EXT_NONE,       nullptr,         0,                    stopwatchRun },
